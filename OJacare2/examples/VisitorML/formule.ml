...
and virtual _souche_jVisiteurML = let jni_ref = ref Java.null
  in
    object (self)
      initializer
        (jni_ref :=
           Java.proxy "fr.upmc.infop6.mlo.VisiteurML"
             (object
                ...
                method visite_5 =
                  fun (_p0 : _jni_jVar) ->
                    let _p0 : jVar = new _capsule_jVar _p0
                    in self#visite_var _p0
                method visite_4 =
                  fun (_p0 : _jni_jOu) ->
                    let _p0 : jOu = new _capsule_jOu _p0
                    in self#visite_ou _p0
                method visite_2 =
                  fun (_p0 : _jni_jEt) ->
                    let _p0 : jEt = new _capsule_jEt _p0
                    in self#visite_et _p0
                method visite_3 =
                  fun (_p0 : _jni_jNon) ->
                    let _p0 : jNon = new _capsule_jNon _p0
         ...
         if Java.is_null !jni_ref
         then raise (Null_object "callback.fr.upmc.infop6.mlo.CB_VisiteurML")
         else ())
...
and virtual _souche_jMainML = let jni_ref = ref Java.null
  in
    object (self)
      initializer
        (jni_ref :=
         ...
         if Java.is_null !jni_ref
         then raise (Null_object "callback.fr.upmc.infop6.mlo.CB_MainML")
         else ())
...
let _new_jConstante_array size =
  let java_obj =
    Java.make_array "fr.upmc.infop6.mlo.Constante[]" (Int32.of_int size)
  in
    OjArray.wrap_reference_array java_obj
      (fun obj -> obj#_get_jni_jConstante)
      (fun r -> new _capsule_jConstante r);;
let _new_jVar_array size =
  let java_obj =
    Java.make_array "fr.upmc.infop6.mlo.Var[]" (Int32.of_int size)
  in
    OjArray.wrap_reference_array java_obj (fun obj -> obj#_get_jni_jVar)
      (fun r -> new _capsule_jVar r);;
let _new_jNon_array size =
  let java_obj =
    Java.make_array "fr.upmc.infop6.mlo.Non[]" (Int32.of_int size)
  in
    OjArray.wrap_reference_array java_obj (fun obj -> obj#_get_jni_jNon)
      (fun r -> new _capsule_jNon r);;
let _new_jOpBin_array size =
  let java_obj =
    Java.make_array "fr.upmc.infop6.mlo.OpBin[]" (Int32.of_int size)
  in
    OjArray.wrap_reference_array java_obj (fun obj -> obj#_get_jni_jOpBin)
      (fun r -> new _capsule_jOpBin r);;
let _new_jEt_array size =
  let java_obj =
    Java.make_array "fr.upmc.infop6.mlo.Et[]" (Int32.of_int size)
  in
    OjArray.wrap_reference_array java_obj (fun obj -> obj#_get_jni_jEt)
      (fun r -> new _capsule_jEt r);;
let _new_jOu_array size =
  let java_obj =
    Java.make_array "fr.upmc.infop6.mlo.Ou[]" (Int32.of_int size)
  in
    OjArray.wrap_reference_array java_obj (fun obj -> obj#_get_jni_jOu)
      (fun r -> new _capsule_jOu r);;
...
let _new_jVisiteurML_array size =
  let java_obj =
    Java.make_array "fr.upmc.infop6.mlo.VisiteurML[]" (Int32.of_int size)
  in
    OjArray.wrap_reference_array java_obj
      (fun obj -> obj#_get_jni_jVisiteurML)
      (fun r -> new _capsule_jVisiteurML r);;
let _new_jMainML_array size =
  let java_obj =
    Java.make_array "fr.upmc.infop6.mlo.MainML[]" (Int32.of_int size)
  in
    OjArray.wrap_reference_array java_obj (fun obj -> obj#_get_jni_jMainML)
      (fun r -> new _capsule_jMainML r);;
let _new_jMainJava_array size =
  let java_obj =
    Java.make_array "fr.upmc.infop6.mlo.MainJava[]" (Int32.of_int size)
  in
    OjArray.wrap_reference_array java_obj (fun obj -> obj#_get_jni_jMainJava)
      (fun r -> new _capsule_jMainJava r);;
class constante _p0 =
  let _p0 = _p0
...
class virtual _stub_jVisiteurML () =
  object (self) inherit _souche_jVisiteurML end;;
class virtual _stub_jMainML () = object (self) inherit _souche_jMainML end;;
let fr_upmc_infop6_mlo_jMainJava__main (_p0 : jMainML) =
  let _p0 = _p0#_get_jni_jMainML
  in
    Java.call
      "fr.upmc.infop6.mlo.MainJava.main(fr.upmc.infop6.mlo.MainML):void" _p0;;
