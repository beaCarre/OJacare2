...
class virtual _souche_jTest (caml_obj:_raw_jTest) =
  let jni_ref = 
  ...
  in 
object (self)
  method _stub_display2 =fun () -> self#display2 ()
  method _stub_toString2 =fun () -> JavaString.of_string (self#toString2())
  method toString2 = 
...
class _stub_jTest caml_obj =
  object (self) inherit _souche_jTest caml_obj end;;
